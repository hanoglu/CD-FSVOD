...
def main():
    ...
    tag = sys.argv[4] if len(sys.argv) > 4 else "voc"
    part_filename = '/root/BHRL/vot_results/target_update_studies/real_time/e100_IoU_0_7_parts/parts_100/{}/results/{}/results_{}_part_{}.txt'. format(tag, seq, seq, part)
    img_folder = "/root/BHRL/VOTIMAGES/{}". format(seq) 
    out_folder = "/root/BHRL/vot_results/target_update_studies/real_time/e100_IoU_0_7_parts/parts_100/{}/update_frames/{}". format(tag, seq)
    ...
    last_update_json = "/root/BHRL/vot_results/target_update_studies/real_time/e100_IoU_0_7_parts/parts_100/{}/update_frames/{}/target_update.json". format(tag, seq)
    ...
    next_part_filename = '/root/BHRL/vot_annotation/{}/with_absent/{}_part_{}.json'. format(seq, seq, str(int(part)+1))
    ...
    template_data["images"][0]["file_name"] = "/root/BHRL/VOTIMAGES/{}/{}.jpg". format(seq, str(best_img_idx).zfill(8))
